...
// Service
import {convertNUSDtoNINR} from '../Services/convertService';
// Dispatch
import {updateMessage} from '../../Redux/snackBarMessageSlice';

const DetailsConvertScreen = props => {
  ...
  const handleBuyRequestConfirm = async () => {
    setisLoading(true);
    const response = await convertNUSDtoNINR(jwtToken, {
      ...
      <View style={styles.buttonStyle}>
        ...
        {!requestSubmitted && (
          <Button
            ...
            {!isLoading && (isConfirm ? 'Click again to - CONFIRM' : 'Convert')}
          </Button>
        )}
      </View>
...
export default DetailsConvertScreen;
